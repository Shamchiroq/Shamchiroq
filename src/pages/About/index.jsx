      ...
      <div className='container pb-10 grid gap-y-12'>
        <div className='main_block'>
          <div className='flex flex-col justify-center items-center'>
            <ul className='grid xl:gap-y-10 gap-y-5 xl:text-start text-center'>
              <h1>Loyiha haqida</h1>
        ...
        <div className='about_desc flex flex-col items-center gap-y-10 xl:px-0 px-5'>
        ...
        <div className='about_video flex flex-col items-center gap-y-10'>
